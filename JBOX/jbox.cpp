...
<title>JBOX 5.2</title>
  ...
  <link rel="icon" href="data:,">
    ...
    <button class="collapsible">Base Scoring</button>
      ...
      <div class="ccontent">
          <input type="number" id="timerNum" placeholder="Timer- 0 for none">
          <select name="Evolver" id="EvolverID">
              <option value="EvolverDom">Basic Domination</option>
              <option value="EvolverDomMaster">Domination Master</option>
              <option value="EvolverShots">Shots Accumulator</option>
              <option value="4a">Red - Capture The Flag</option>
              <option value="4b">Blue - Capture The Flag</option>
              <option value="4c">Yellow - Capture The Flag</option>
              <option value="4d">Green - Capture The Flag</option>
              <option value="4e">Respawn - Cover Station</option>
              <option value="4f">Own The Zone</option>
              <option value="4g">Medic - BRoyale Checkpoint</option>
              <option value="4h">Upgrade Station</option>
              <option value="16">IR Test Mode</option>
              <option value="IRDebug">IR Debug</option>     
          </select>
          <select name="Background" id="BackgroundID">
              <option value="xx">Enable Any Background Functions</option>
              <option value="EvolverArcade">Arcade Mode</option>
              <option value="PSaverOn">Power Saver - On</option>
              <option value="PSaverOff">Power Saver - Off</option>
          </select>
      </div>
